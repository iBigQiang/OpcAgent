...
import { RPC_CHANNELS, type FileAttachment, type DirectoryListingResult } from '@opcagent/shared/protocol'
import type { StoredAttachment } from '@opcagent/core/types'
import { readFileAttachment, validateImageForClaudeAPI, IMAGE_LIMITS } from '@opcagent/shared/utils'
import { getSessionAttachmentsPath, validateSessionId } from '@opcagent/shared/sessions'
import { getWorkspaceByNameOrId } from '@opcagent/shared/config'
import { resizeImageForAPI, inspectImageBuffer } from '@opcagent/server-core/services'
import { sanitizeFilename, validateFilePath, getWorkspaceAllowedDirs } from '@opcagent/server-core/handlers'
