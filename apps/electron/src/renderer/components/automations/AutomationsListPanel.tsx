...
import { getEventDisplayName, matchesAutomationFilter, type AutomationListItem, type AutomationListFilter } from './types'
...
export function AutomationsListPanel({
  ...
  const categoryFiltered = React.useMemo(() => {
    return automations.filter(automation => matchesAutomationFilter(automation.event, automationFilter))
  }, [automations, automationFilter])
