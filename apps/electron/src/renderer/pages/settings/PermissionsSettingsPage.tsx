 ...
 * Shows both default patterns (from ~/.opcagent/permissions/default.json)
 * and custom workspace additions (from workspace permissions.json).
 *
 * Default patterns can be edited by the user in ~/.opcagent/permissions/default.json.
...
import { type PermissionsConfigFile } from '@opcagent/shared/agent/modes'
import {
...
/**
 * Build default permissions data from ~/.opcagent/permissions/default.json.
