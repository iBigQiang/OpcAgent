...
export const CHANNEL_MAP = {
  ...
  moveLabel: invoke(RPC_CHANNELS.labels.MOVE),
  reorderLabels: invoke(RPC_CHANNELS.labels.REORDER),
  ...
  getMessagingRuntime: invoke(RPC_CHANNELS.messaging.GET_RUNTIME),
  saveMessagingCredential: invoke(RPC_CHANNELS.messaging.SAVE_CREDENTIAL),
  forgetMessagingCredential: invoke(RPC_CHANNELS.messaging.FORGET_CREDENTIAL),
  testTelegramToken: invoke(RPC_CHANNELS.messaging.TEST_TELEGRAM),
  testLarkCredentials: invoke(RPC_CHANNELS.messaging.TEST_LARK),
  connectMessagingPlatform: invoke(RPC_CHANNELS.messaging.CONNECT),
