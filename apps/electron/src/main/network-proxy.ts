...
import { getNetworkProxySettings, setNetworkProxySettings } from '@opcagent/shared/config/storage';
import type { NetworkProxySettings } from '@opcagent/shared/config/types';
